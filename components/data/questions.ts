...
export const questionsByWeek: { [week: string]: Question[] } = {
    week1: [
        ...
        {
            question: "The rate of any biological process is limited by that factor in least amount relative to requirement, so there is a single limiting factor.",
            options: [
    ...
    week10: [
        ...
        {
            question: "Oil that has not been drilled can be categorized under",
            options: [
                "potential resources",
                "actual resources",
                "reserve resources",
        ...
        {
            question: "Timber from forests that is being harvested can be categorized under",
            options: [
                "potential resources",
                "actual resources",
                "reserve resources",
    ...
    week11: [
        {
            question: "Oxford can best be categorized as",
            options: [
                "mining town",
                "garrison town",
                "educational town",
        ...
        {
            question: "New Delhi can best be categorized as",
            options: [
                "administrative town",
                "industrial town",
                "transport town",
        ...
        {
            question: "Visakhapatnam can best be categorized as",
            options: [
                "administrative town",
                "industrial town",
                "transport town",
        ...
        {
            question: "Bhilai can best be categorized as",
            options: [
                "administrative town",
                "industrial town",
                "transport town",
        ...
        {
            question: "Singrauli can best be categorized as",
            options: [
                "mining town",
                "garrison town",
                "educational town",
